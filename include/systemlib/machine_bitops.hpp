...
#ifndef _EXNG2_SYSTEMLIB_MACHINE_BITOPS_HPP_
# define _EXNG2_SYSTEMLIB_MACHINE_BITOPS_HPP_
...
#include <systemlib/machine_bitops_native.hpp>
...
namespace Machine {
  ...
  #ifndef _EXNG2_MACHINE_HAS_ROL64
  inline uint64 rotLeft64(uint32 bits, uint64 val)
  {
    bits &= 63;
  ...
  #ifndef _EXNG2_MACHINE_HAS_ROR64
  inline uint64 rotRight64(uint32 bits, uint64 val)
  {
    bits &= 63;
    return val>>bits | val<<(64-bits);
  }
