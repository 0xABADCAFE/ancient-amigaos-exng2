///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  File:         platforms/amigaos41_ppc/systemlib/thread_native.hpp
//  Tab Size:     2
//  Max Line:     120
...
{
  return threadForTask(OSNative::IExec->FindTask(0));
}
...
{
  if (OSNative::IExec->FindTask(0) == &(internal->pr_Task)) {
...
{
  return OSNative::IExec->Wait(trigger);
}
