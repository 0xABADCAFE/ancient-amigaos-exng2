...
_testWrite__10XSFTestApp:
	...
	addl #-314,d2
	movel d2,sp@-
	jbsr ___Q23XSF9StreamOut
	movel a5@(-330),a1
	movel a1@(4),a0
	addql #4,a0
	movel a0@,a5@(-326)
	movel #__$_Q23XSF9StreamOut,a5@(-322)
	movel d2,a5@(-318)
	lea a5@(-326),a1
	movel a1,a0@
	clrl d3
	...
	movel #_printf,d6
	movel #_sprintf,d5
	movel #_open__Q23XSF9StreamOutPCcT1UsUsUcUl,d4
	lea _close__Q23XSF9StreamOut,a6
	moveq #-80,d2
	addl a5,d2
	movel d7,a3
	lea a5@(-41),a4
...
L556:
	...
	pea a5@(-16)
	movel a3,sp@-
	jbsr _writeBytes__Q22IO9StreamOutPCvUl
	addqw #8,sp
	movel #8,sp@
	pea a5@(-16)
	movew a5@(-104),a0
...
_testRead1__10XSFTestApp:
	...
	addl #-278,d2
	movel d2,sp@-
	jbsr ___Q23XSF8StreamIn
	movel a4@(4),a0
	addql #4,a0
	movel a0@,a5@(-290)
	movel #__$_Q23XSF8StreamIn,a5@(-286)
	movel d2,a5@(-282)
	lea a5@(-290),a1
	movel a1,a0@
	clrl d7
...
L571:
	...
	movel d2,sp@-
	movel d5,sp@-
	jbsr _open__Q23XSF8StreamInPCcUl
	addw #32,sp
	movew a5@(-94),d4
	movel d4,sp@-
	movew a5@(-96),d3
...
.comm ___tiQ23XSF10StreamUser,8
LC13:
	.ascii "Q23XSF10StreamUser\0"
	.even
...
L589:
	...
	rts
	.even
___tfQ23XSF10StreamUser:
	movel a2,sp@-
	lea ___tiQ23XSF10StreamUser,a2
	tstl a2@
	jne L591
	pea LC13
	movel a2,sp@-
