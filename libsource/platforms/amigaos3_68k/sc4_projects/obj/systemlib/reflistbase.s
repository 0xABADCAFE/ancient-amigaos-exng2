...
L210:
	...
	rts
	.even
.globl _find__Q211EXNGPrivate8VoidListPv
_find__Q211EXNGPrivate8VoidListPv:
	movel sp@(4),a0
	movel sp@(8),a1
	movel a0@,d0
	jlt L213
...
L218:
	...
	nop
	.even
.globl _remove__Q211EXNGPrivate8VoidListPv
_remove__Q211EXNGPrivate8VoidListPv:
	movel d2,sp@-
	movel sp@(12),sp@-
	movel sp@(12),sp@-
	jbsr _find__Q211EXNGPrivate8VoidListPv
	movel d0,d2
	addql #8,sp
	moveq #-1,d0
	cmpl d2,d0
