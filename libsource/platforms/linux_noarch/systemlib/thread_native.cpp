///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//  File:         platforms/linux_noarch/systemlib/thread_native.cpp
//  Tab Size:     2
//  Max Line:     120
//  Description:  Native thread classes - generic pthread version
//  Comment(s):
//  Library:      System
//  Created:      2007-01-12
//  Updated:      2007-01-12
...
// TO DO - sensible values needed for pthread
...
: classID(IDTAG), internal(0), external(0), runJob(0), runObs(0), stateObs(0), uptime(),
...
: classID(IDTAG), internal(0), external(0), runJob(job), runObs(0), stateObs(0), uptime(),
  priority((uint8)pri), stateFlags(0), sleepFlags(0), taskState(0)
{
  sharedInit(stack);
}
...
void Thread::sharedInit(uint32 stack)
{
  ...
  if (!internal) {
    parent = threadForTask(pthread_self());
  }
  else {
    parent = 0;
  }
